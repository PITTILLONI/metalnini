...
public enum Catalog {
    ...
    public static let binders: [Binder] = [
        ...
        .init(id: "poppunk", kind: .style, label: "Pop punk", musicianIDs: ["blink182", "hoppus", "hayley", "armstrong"]),
        .init(id: "legendes", kind: .style, label: "Légendes du rock", musicianIDs: ["hendrix", "slash", "frusciante", "angus"]),
        .init(id: "heavy", kind: .style, label: "Heavy metal", musicianIDs: ["dickinson", "halford", "ozzy", "lemmy"]),
        .init(id: "thrash", kind: .style, label: "Thrash", musicianIDs: ["hetfield", "mustaine", "araya", "scott-ian"]),
        ...
        .init(id: "guitaristes", kind: .instrument, label: "Les guitaristes", musicianIDs: ["isaac-hale", "hendrix", "slash", "frusciante", "root", "mustaine", "scott-ian", "angus"]),
