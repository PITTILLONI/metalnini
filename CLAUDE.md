...
- Back-end Supabase `mdnevzmczljycmgbsrsu` : migrations 0001 à 0012 appliquées ; 38 musiciens, 190 cartes.
...
- En attente : TestFlight (inscription Apple Developer), inscription par e-mail dans l'app iOS, domaine d'e-mail dédié, paquets dédiés aux nouveaux styles, musique de fond (piste libre de droits à choisir).
