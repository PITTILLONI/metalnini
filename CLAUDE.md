...
- Back-end Supabase `mdnevzmczljycmgbsrsu` : migrations 0001 à 0023 appliquées (depuis 0006, par l'API de gestion avec le seul `supabase-token` : `POST https://api.supabase.com/v1/projects/mdnevzmczljycmgbsrsu/database/query`, l'historique de la CLI s'arrête donc à 0005) ; 45 musiciens, 225 cartes.
