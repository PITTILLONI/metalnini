...
- Back-end Supabase `mdnevzmczljycmgbsrsu` : migrations 0001 à 0017 appliquées, 0018 (avis de cadeau) et 0019 (demandes d'artistes) écrites, à appliquer ; 44 musiciens, 220 cartes en base (seed à rejouer pour Prince : 45 musiciens, 225 cartes dans le catalogue).
